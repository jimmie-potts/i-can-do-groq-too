...
This directory distinguishes accepted architecture, delivery plans, and implementation-backed
learning evidence.
...
| Document | Purpose |
| --- | --- |
| [Project brief](project-brief.md) | Recovered goals and constraints from the originating conversation |
| [Architecture](architecture.md) | Component ownership, data flow, and cross-repository boundaries |
